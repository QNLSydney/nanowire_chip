...
for i in range(no_windows):
    ...
    current_coordinate += window_size + window_spacing
    window_size += window_increment
#nw1_coords = [[ 178.75926118   36.97741917]]
#nw2_coords = [[ 176.86294581   47.37024027]]
#nw1_coords = [[ 183.56550218   36.9485393 ]]
#nw2_coords = [[ 181.6182012    47.33324347]]
...
for i in range(no_windows):
    ...
    current_coordinate += window_size + window_spacing
    window_size += window_increment
#nw1_coords = [[ 189.59402801  149.17281755]]
#nw2_coords = [[ 198.08165492  152.47842491]]
